...
public class ExchangeRateServiceImpl implements ExchangeRateService {
    ...
    public List<CurrentRatesDTO> getBankStyleRates() {
        ...
        currentRates = currentRates.stream()
                .filter(r -> !r.getBaseCurrency().equalsIgnoreCase(r.getTargetCurrency()))
                .toList();
    ...
    @Override
    public List<CurrentRatesDTO> getRateByBaseCurrency(String baseCurrency) {
        var currentRates = exchangeRateRepository.findAllByBaseCurrencyAndCurrentRate(baseCurrency,true);
